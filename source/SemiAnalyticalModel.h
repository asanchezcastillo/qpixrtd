...
private:
  ...
  double Rectangle_SolidAngleVD(Dims const& o,Vector_t const& v) const;
  double Rectangle_SolidAngleHD(Dims const& o,Vector_t const& v) const;
  ...
  const bool fDetectorVDConfiguration;
